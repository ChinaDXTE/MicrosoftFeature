using NewsSample.Common.NotificationsEx;
using NewsSample.Common.NotificationsEx.ToastContent;
using System;
...
namespace NewsSample.Common
{
    public class Notifications
    {
        ...
        public void CreateTileWide310x150PeekImageCollection01(string backTitle, string backContent)
        {
            ...
            tileContent.TextHeading.Text = backTitle;
            tileContent.TextBodyWrap.Text = backContent;
            tileContent.ImageSmallColumn1Row1.Src = "ms-appdata:///local/test/test1.png";
